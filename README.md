# Regulatory Intel MCP — by SelfLabbs
...
```
claude mcp add --transport http regulatory-intel https://regulatory.selflabbs.com/mcp
```

Or point any MCP client at `https://regulatory.selflabbs.com/mcp`.
